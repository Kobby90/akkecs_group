...
export default function Security() {
  return (
    <div className="bg-transparent min-h-screen pt-32 pb-20 relative overflow-hidden">
      ...
      <div className="absolute inset-y-0 right-0 w-1/2 z-0 opacity-[0.25] pointer-events-none hidden lg:block">
        <Image
          src="/portraite2.png"
      ...
      <div className="max-w-screen-lg mx-auto px-6 relative z-10">
        <div className="mb-12 text-center">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-green-500/10 border border-green-500/20 mb-6 backdrop-blur-md">
            <span className="text-xs font-bold tracking-wider text-green-650 uppercase font-mono">Trust &amp; Safety</span>
          </div>
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl p-8 md:p-12 shadow-xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-green-50 text-green-600 border border-green-100 flex items-center justify-center mr-3">
            ...
            <p className="text-slate-650">We protect data both in transit and at rest:</p>
            <ul className="space-y-3 list-none pl-0">
              {[
                ...
                <li key={i} className="flex items-start bg-slate-50 rounded-lg p-4 border border-slate-200/50">
            ...
            <p className="text-slate-650">We enforce strict controls to ensure data is accessible only to those who need it:</p>
            <div className="grid md:grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="flex items-start p-4 rounded-xl bg-slate-50 border border-slate-200 hover:border-green-500/50 transition-colors">
                  <svg className="w-5 h-5 text-green-650 mr-3 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span className="text-slate-750 text-sm font-medium">{item}</span>
                </div>
              ))}
            </div>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex items-start p-5 rounded-xl bg-slate-50 border border-slate-200">
                  <div className="w-2 h-2 rounded-full bg-green-550 mr-4 mt-2 flex-shrink-0"></div>
                  <div>
            ...
            <p className="text-slate-650 mt-4 font-semibold">Application security — built into our development lifecycle:</p>
            <ul className="space-y-3 list-none pl-0">
              {[
            ...
            <p className="text-slate-650">We maintain continuous monitoring of our systems:</p>
            <ul className="space-y-3 list-none pl-0 mb-6">
              {[
                ...
                <li key={i} className="flex items-start bg-slate-50 rounded-lg p-4 border border-slate-200/50">
                  <div className="w-2 h-2 rounded-full bg-green-500 mr-3 mt-2 flex-shrink-0"></div>
                  <span className="text-slate-755 text-base font-medium">{item}</span>
                </li>
              ))}
            </ul>
            <p className="text-slate-650 font-semibold">In the event of a security incident:</p>
            <ul className="space-y-3 list-none pl-0">
              {[
            ...
            <p className="text-slate-650">Before engaging any service provider who will access personal or confidential data, we:</p>
            <div className="grid md:grid-cols-2 gap-4">
              {[
            ...
            <ul className="space-y-3 list-none pl-0">
              {[
                ...
                <li key={i} className="flex items-start">
                  ...
                  <span className="text-slate-755 font-medium">{item}</span>
                </li>
              ))}
            </ul>
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-6 mb-6">
              <p className="text-green-800 m-0 text-base font-medium">
                <span className="font-semibold text-slate-900">Email:</span>{' '}
                <a href="mailto:compliance@fintrivoratech.com" className="text-green-600 hover:text-green-700 no-underline border-b border-green-650/30 hover:border-green-700">
                  compliance@fintrivoratech.com
                </a>
                <br />
                <span className="font-semibold text-slate-900">Subject:</span>{' '}
                <span className="text-green-700">Responsible Disclosure — Security Vulnerability</span>
              </p>
            </div>
            <p className="text-slate-650">We ask that you:</p>
            ...
            <p className="text-slate-650">Our security programme is aligned with:</p>
            <div className="grid md:grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="flex items-center p-4 rounded-xl bg-slate-50 border border-slate-200 hover:border-green-500/50 transition-colors">
                  <div className="w-2 h-2 rounded-full bg-green-500 mr-3 flex-shrink-0"></div>
                  <span className="text-slate-750 font-medium text-sm">{item}</span>
                </div>
              ))}
            </div>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
              <p className="text-slate-755 m-0 font-medium">
                <span className="font-semibold text-slate-900">Email: </span>
                <a href="mailto:compliance@fintrivoratech.com" className="text-green-600 hover:text-green-700 no-underline border-b border-green-600/30 hover:border-green-700">
                  compliance@fintrivoratech.com
                </a>
              </p>
            </div>
