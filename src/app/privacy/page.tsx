...
export default function Privacy() {
  return (
    <div className="bg-transparent min-h-screen pt-32 pb-20 relative overflow-hidden">
      <div className="absolute inset-y-12 right-0 w-1/2 h-full z-0 opacity-[0.25] pointer-events-none hidden lg:block">
        <Image
          src="/portraite.png"
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#FAFAFD] via-transparent to-transparent"></div>
        <div className="absolute inset-0 bg-gradient-to-t from-[#FAFAFD] via-transparent to-[#FAFAFD]"></div>
      </div>
      <div className="max-w-screen-lg mx-auto px-6 relative z-10">
        <div className="mb-12 text-center">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 mb-6 backdrop-blur-md">
            <span className="text-xs font-bold tracking-wider text-blue-650 uppercase">Legal</span>
          </div>
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl p-8 md:p-12 shadow-xl">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-slate-650">
              ...
              <a href="mailto:compliance@fintrivoratech.com" className="text-blue-600 hover:text-blue-700 no-underline border-b border-blue-600/30 hover:border-blue-700">
                compliance@fintrivoratech.com
              </a>.
            </p>

            {/* Section 01 */}
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 border border-blue-100 flex items-center justify-center mr-3 text-sm">01</span>
              Information We Collect
            </h2>
            <p className="text-slate-700 font-semibold">Information you provide directly, including:</p>
            <ul className="grid md:grid-cols-2 gap-4 list-none pl-0">
              {[
                ...
                <li key={i} className="flex items-center bg-slate-50 rounded-lg p-4 border border-slate-200/50">
                  <div className="w-2 h-2 rounded-full bg-blue-500 mr-3 flex-shrink-0"></div>
                  <span className="text-slate-750 text-base font-medium">{item}</span>
                </li>
              ))}
            </ul>
            <p className="text-slate-700 font-semibold mt-6">Information collected automatically when you visit our website:</p>
            <ul className="grid md:grid-cols-2 gap-4 list-none pl-0">
              {[
            ...
            <p className="text-slate-650 mt-4">
            ...
            <p className="text-slate-650">
              We also receive <strong className="text-slate-800">information from third parties</strong>, such as publicly available sources or business
            ...
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 border border-blue-100 flex items-center justify-center mr-3 text-sm">02</span>
              How We Use Your Information
            </h2>
            <p className="text-slate-650">We use your information to:</p>
            <ul className="space-y-3 list-none pl-0">
              {[
                ...
                <li key={i} className="flex items-start">
                  ...
                  <span className="text-slate-750 font-medium">{item}</span>
                </li>
              ))}
            </ul>
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mt-6">
              <p className="text-blue-800 m-0 text-base font-medium">
            ...
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 border border-blue-100 flex items-center justify-center mr-3 text-sm">03</span>
              Sharing Your Information
            </h2>
            <p className="text-slate-650">We share your information only in the following circumstances:</p>
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex items-start p-5 rounded-xl bg-slate-50 border border-slate-200">
                  ...
                  <div>
                    ...
                    <span className="text-slate-650"> — {item.desc}</span>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 border border-blue-100 flex items-center justify-center mr-3 text-sm">04</span>
            ...
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 border border-blue-100 flex items-center justify-center mr-3 text-sm">05</span>
              Cookies
            </h2>
            <p className="text-slate-650">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="flex items-start p-4 rounded-xl bg-slate-50 border border-slate-200 hover:border-blue-500/50 transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-slate-650 text-sm m-0 mt-1">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 border border-blue-100 flex items-center justify-center mr-3 text-sm">06</span>
              Data Retention
            </h2>
            <p className="text-slate-650">We retain your personal information only for as long as necessary:</p>
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="flex items-start justify-between p-4 rounded-xl bg-slate-50 border border-slate-200 gap-4">
                  <span className="text-slate-750 font-medium">{item.label}</span>
                  <span className="text-blue-600 text-sm font-semibold text-right flex-shrink-0">{item.period}</span>
                </div>
              ))}
            </div>
            <p className="text-slate-650 mt-4">
            ...
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 border border-blue-100 flex items-center justify-center mr-3 text-sm">07</span>
              Your Rights
            </h2>
            <p className="text-slate-650">Under the Data Protection Act, 2012 (Act 843), you have the right to:</p>
            <div className="grid md:grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="flex items-start p-4 rounded-xl bg-slate-50 border border-slate-200 hover:border-blue-500/50 transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-slate-650 text-sm m-0 mt-0.5">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
            <p className="text-slate-655 mt-4">
            ...
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 border border-blue-100 flex items-center justify-center mr-3 text-sm">08</span>
            ...
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 border border-blue-100 flex items-center justify-center mr-3 text-sm">09</span>
              Children&apos;s Privacy
            </h2>
            <p className="text-slate-650">
            ...
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 border border-blue-100 flex items-center justify-center mr-3 text-sm">10</span>
            ...
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 border border-blue-100 flex items-center justify-center mr-3 text-sm">11</span>
              Contact Us
            </h2>
            <p className="text-slate-650">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
              <p className="text-slate-755 m-0 font-medium">
