...
export default function Terms() {
  return (
    <div className="bg-transparent min-h-screen pt-32 pb-20 relative overflow-hidden">
      <div className="absolute inset-y-12 left-0 w-1/2 h-full z-0 opacity-[0.25] pointer-events-none hidden lg:block">
        <Image
          src="/portraite2.png"
      ...
      <div className="max-w-screen-lg mx-auto px-6 relative z-10">
        <div className="mb-12 text-center">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-6 backdrop-blur-md">
            <span className="text-xs font-bold tracking-wider text-cyan-650 uppercase">Legal</span>
          </div>
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl p-8 md:p-12 shadow-xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-cyan-50 text-cyan-600 border border-cyan-100 flex items-center justify-center mr-3 text-sm">1</span>
              About Our Services
            </h2>
            ...
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-cyan-50 text-cyan-600 border border-cyan-100 flex items-center justify-center mr-3 text-sm">2</span>
              Eligibility
            </h2>
            <p className="text-slate-650">By using our website, you confirm that:</p>
            <ul className="space-y-3 list-none pl-0">
              {[
                ...
                <li key={i} className="flex items-start">
                  ...
                  <span className="text-slate-750">{item}</span>
                </li>
              ))}
            </ul>
            ...
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-cyan-50 text-cyan-600 border border-cyan-100 flex items-center justify-center mr-3 text-sm">3</span>
              User Obligations
            </h2>
            <p className="text-slate-650">You agree to:</p>
            <ul className="space-y-3 list-none pl-0">
              {[
            ...
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-cyan-50 text-cyan-600 border border-cyan-100 flex items-center justify-center mr-3 text-sm">4</span>
              Intellectual Property
            </h2>
            <div className="bg-slate-50 border border-slate-100 border-l-4 border-l-cyan-500 p-6 rounded-r-xl">
              <p className="text-slate-750 m-0 text-base">
            ...
            <p className="text-slate-650 mt-4">
              ...
              for personal, non-commercial informational purposes only. This licence does <strong className="text-slate-800">not</strong> include the right to:
            </p>
            <ul className="space-y-3 list-none pl-0">
              {[
            ...
            <p className="text-slate-650 mt-4">
              ...
              <a href="mailto:compliance@fintrivoratech.com" className="text-cyan-600 hover:text-cyan-700 no-underline border-b border-cyan-600/30 hover:border-cyan-700">
            ...
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-cyan-50 text-cyan-600 border border-cyan-100 flex items-center justify-center mr-3 text-sm">5</span>
              Third-Party Links
            </h2>
            <p className="text-slate-650">
            ...
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-cyan-50 text-cyan-600 border border-cyan-100 flex items-center justify-center mr-3 text-sm">6</span>
              Disclaimer of Warranties
            </h2>
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-6">
              <p className="text-amber-800 m-0 text-base font-medium">
            ...
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-cyan-50 text-cyan-600 border border-cyan-100 flex items-center justify-center mr-3 text-sm">7</span>
            ...
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-cyan-50 text-cyan-600 border border-cyan-100 flex items-center justify-center mr-3 text-sm">8</span>
              Privacy
            </h2>
            <p className="text-slate-650">
            ...
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-cyan-50 text-cyan-600 border border-cyan-100 flex items-center justify-center mr-3 text-sm">9</span>
            ...
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-cyan-50 text-cyan-600 border border-cyan-100 flex items-center justify-center mr-3 text-sm">10</span>
              Governing Law
            </h2>
            <div className="bg-slate-50 border border-slate-100 border-l-4 border-l-cyan-500 p-6 rounded-r-xl">
              <p className="text-slate-750 m-0 text-base">
            ...
            <div className="my-12 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-cyan-50 text-cyan-600 border border-cyan-100 flex items-center justify-center mr-3 text-sm">11</span>
              Contact
            </h2>
            <p className="text-slate-650">If you have any questions about these Terms of Service:</p>
